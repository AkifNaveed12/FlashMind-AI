    ...
    >
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold text-xs flex items-center justify-center gap-1.5 transition-all disabled:bg-slate-100 disabled:text-slate-400 active:scale-95"
        ...
        <button
          ...
          className="px-4 py-2 border border-slate-200 hover:border-red-200 text-slate-500 hover:text-red-600 hover:bg-red-50/50 rounded-xl transition-all disabled:border-slate-100 disabled:text-slate-300 disabled:hover:bg-transparent"
          title="Stop and exit"
        >
